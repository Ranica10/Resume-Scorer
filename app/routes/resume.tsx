        ...
        <main className="!pt-0">
            ...
            <div className="flex flex-row w-full max-lg:flex-col-reverse">
                <section className="feedback-section bg-[url('/images/bg_small.svg')] bg-cover h-[100vh] sticky top-0 items-center justify-center">
                    {/* Display the resume as an image in the browser */}
                    {imageUrl && resumeUrl && (
                        <div className="animate-in fade-in duration-1000 gradient-border max-sm:m-0 h-[90%] max-wxl:h-fit w-fit">
                            {/* Click on the img to open the actual pdf */}
                ...
                <section className="feedback-section">
                    ...
                    {feedback ? (
                        <div className="flex flec-col gap-8 animate-in fade-in duration-1000">
